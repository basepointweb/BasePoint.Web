...
import InterfaceTitle from '@/components/shared/interface-title/interface-title'
      ...
      <Master children = {
        ...
        <Box>
          <Element  name="BaseEntity">
            <InterfaceTitle classDeclarationName="ICqrsQueryProvider"/> 
...
export default QueryProviderInterface;